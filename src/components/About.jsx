...
const About = () => {
  return (
    <div className="aboutMe">
      ...
      Right now, I'm currently building my stack on Javascript.
      </p>
      {skills}
      <div className="contactMe">
        <a class="underline-button text-color" rel="noopener noreferrer" target="_blank" href="https://github.com/oluwashane">Github</a>
        <a className="underline-button text-color" rel="noopener noreferrer" target="_blank" href="mailto:hi@jonasf.work">Email</a>
      </div>
